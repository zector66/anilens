...
export interface GameQuestion {
  id: string;
  type: 'OP_GUESS' | 'SCREENSHOT_GUESS' | 'QUOTE_GUESS' | 'SCORE_GUESS' | 'CHARACTER_GUESS' | 'SEASON_MATCH' | 'COVER_GUESS' | 'CHAPTER_COUNT_GUESS' | 'HANGMAN' | 'WORDLE' | 'SEIYUU_GUESS' | 'TAG_OR_CAP' | 'POPULARITY_BATTLE' | 'TASTE_CONSISTENCY' | 'STUDIO_MATCH' | 'VA_CONNECTION' | 'RELATION_TYPE' | 'SCORE_LADDER' | 'TAG_LADDER';
  media?: Media;
