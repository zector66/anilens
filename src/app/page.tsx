        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 max-w-2xl mx-auto">
            {[
              ...
              { value: '10M+', label: 'Anime Analyzed' },
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="p-12 rounded-3xl bg-linear-to-br from-purple-500/20 to-blue-500/20 border border-white/10">
            ...
            <p className="text-gray-400 mb-8 max-w-lg mx-auto">
              Join thousands of anime fans who have uncovered their true taste. It only takes a minute to get started.
            </p>
            <LoginButton variant="hero" />
          </div>
        </div>
